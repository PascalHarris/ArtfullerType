...
resource 'ICN#' (128) {
    {
        $"FFFFFFFFFFFEFFFFFFEB5BFFFFAAAEFF"
        $"FEBFF5FFFD555EBFFAFFF77FFB407DAF"
        $"E5C03FDFF7E03EEFCAF81BB7EFF91FEB"
        $"CBF18FBFEFB18FEB96F3CFF5AFE1475B"
        $"97E007F5CFC003EBD6C7FFB5CF8FC0F7"
        $"CB018053CD03302BE7DFC817E2FE7F8F"
        $"F1BA300FF8EF0017FC3E8017FE15E027"
        $"FF425FE7FFC00BFFFFFCBFFFFFFFFFFF"
...
resource 'ICN#' (129) {
    {
        $"FFFFFFFFF80003FFF80002FFF800027F"
        $"F800023FF83FC3FFF81FC01FF807C01F"
        $"F806601FF806601FF80C301FF80C301F"
        $"F818301FF818181FF81FF81FF83FFC1F"
        $"F8300C1FF8600C1FF860061FF8F81F1F"
        $"F9FC3F9FF800001FF800001FF800001F"
        $"F800A71FF801549FF801549FF801549F"
        $"F805571FF800001FF800001FFFFFFFFF"
...
resource 'ICN#' (130) {
    {
        ...
        $"F8300C1FF8600C1FF860061FF8F81F1F"
        $"F9FC3F9FF800001FF800001FF800001F"
        $"F8739DDFF84A511FF873999FF842511F"
        $"F8425D1FF800001FF800001FFFFFFFFF"
        $"0FFFFE000FFFFF000FFFFF800FFFFFC0"
        $"0FFFFFE00FFFFFF00FFFFFF00FFFFFF0"
        $"0FFFFFF00FFFFFF00FFFFFF00FFFFFF0"
        $"0FFFFFF00FFFFFF00FFFFFF00FFFFFF0"
